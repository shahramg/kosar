...
//			} else rs = st.executeQuery(query);
	...
	public void run() {
		...
		try {
			...
			if (rs.next()) {
				System.out.println("usercount="+ rs.getString(1));
			} else
...
//		HashMap<String, ByteIterator> res2 = new HashMap<String,ByteIterator>();
//		getUserProfile(1,1,res2, false, false);
...
//		getUserProfile(3, 3, res2, false, false);
//		getUserProfile(5, 3, res2, false, false);
//		inviteFriends(35, 3);
//		
//		getUserProfile(35, 35, res2, false, false);
//		getUserProfile(5, 35, res2, false, false);
//		getUserProfile(3, 3, res2, false, false);
//		getUserProfile(5, 3, res2, false, false);
//		acceptFriendRequest(35, 3);
//		
//		getUserProfile(35, 35, res2, false, false);
//		getUserProfile(5, 35, res2, false, false);
//		getUserProfile(3, 3, res2, false, false);
...
//		unFriendFriend(35, 3);
	...
	public int testGeneratingMultiTriggers() {
		int requesterID = 1;
		int profileOwnerID = 50;
...
//						query);
			...
			if (rs.next()) {
				String friendCount = rs.getString(1);
...
//		if (requesterID == profileOwnerID) {
			...
			try {
				...
				rs = preparedStatement.executeQuery();
				if (rs.next()) {
					String pendingCount = rs.getString(1);
...
//		p.setProperty(CONNECTION_URL, "kosarsolo:jdbc:mysql://127.0.0.1:3306/bgbench1?autoReconnect=true");
		...
		//Oracle
		p.setProperty(CONNECTION_URL, "kosarsolo:jdbc:oracle:thin:@//10.0.0.215:1521/ORCL");
		p.setProperty(CONNECTION_USER, "hieunguyen");
		p.setProperty(CONNECTION_PASSWD, "hieunguyen123");
